...
def weiv():
    ...
    if modul.mode == "e_see":
        ...
        text = answered.render("полёт шариков вверх- клавиша 3", True, [r, g, b], [0, 0, 0])
        screen.blit(text, [12, 175])
        text = answered.render("полёт шариков вниз- клавиша 4", True, [r, g, b], [0, 0, 0])
        screen.blit(text, [12, 200])
        text = answered.render("полёт шариков влево- клавиша 5", True, [r, g, b], [0, 0, 0])
        screen.blit(text, [12, 225])
        text = answered.render("полёт шариков вправо- клавиша 6", True, [r, g, b], [0, 0, 0])
        screen.blit(text, [12, 250])
    pygame.display.flip()
